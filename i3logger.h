...
#define I3LOG_FILE_AND_LINE     i3::Logger::extractFilename(__FILE__) << "(" << I3STRINGIZE(__LINE__) << "): "
...
#define i3log           i3::Logger::i3log_instance << I3LOG_PREFIX
///Warning log stream.
#define i3logWarn       i3::Logger::i3logWarn_instance << I3LOG_WARNING_PREFIX " "
///Error log stream.
#define i3logErr        i3::Logger::i3logErr_instance <<  I3LOG_ERROR_PREFIX " "

///Debug log stream. Compile out in debug (assuming compiler properly optimizes it out).
#if I3DEBUG
#   define i3logDebug   i3::Logger::i3logDebug_instance << I3LOG_DEBUG_PREFIX " "
#else
